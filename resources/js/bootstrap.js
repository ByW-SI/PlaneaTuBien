...
function cotizar() {
    ...
    $("#cotizador").empty();
    if($('input[name=plan-radio]:checked').val() != "libre"){
        axios.get(`../../../../../api/cotizar/${monto}/${plan_id}/${descuento}`).then(res=>{
            ...
            <div class="row">
                ...
                <div class="col-12 col-xs-12 col-md-4 col-lg-4 col-xl-4 form-group">
                    <label for="monto">${ plan.abreviatura != 'TC' && plan.abreviatura != 'TD' ? plan.mes_aportacion_adjudicado : ''} mensualidades de</label>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1">$</span>
                        </div>
