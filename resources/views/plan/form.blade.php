			...
			<div class="card-body">
				...
				<div class="row">
					<div class="col-12 col-sm-12 col-md-6 col-lg-4 offset-lg-2 col-xl-4 offset-xl-2 form-group">
						...
						<div class="input-group mb-3">
							<input type="number" step="any" name="aportacion_1" value="{{old("aportacion_1")}}" min="0" class="form-control" placeholder="Porcentaje de aportación" aria-label=" plan" aria-describedby="basic-addon2" required="">
							<div class="input-group-append">
								<span class="input-group-text " id="basic-addon2">%</span>
							</div>
						</div>
					...
					<div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 form-group">
						...
						<div class="input-group mb-3">
							...
							<input type="number" step="1" name="mes_1" value="{{old("mes_1")}}" min="1" class="form-control" placeholder="Mes en el que se cobrara esta aportación" aria-label=" plan" aria-describedby="basic-addon2" required="">
							<div class="input-group-append">
				...
				<div class="row">
					<div class="col-12 col-sm-12 col-md-6 col-lg-4 offset-lg-2 col-xl-4 offset-xl-2 form-group">
						...
						<div class="input-group mb-3">
							<input type="number" step="any" name="aportacion_2" value="{{old("aportacion_2")}}" min="0" class="form-control" placeholder="Porcentaje de aportación" aria-label=" plan" aria-describedby="basic-addon2" required="">
							<div class="input-group-append">
								<span class="input-group-text " id="basic-addon2">%</span>
							</div>
						</div>
					...
					<div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 form-group">
						...
						<div class="input-group mb-3">
							...
							<input type="number" step="1" name="mes_2" value="{{old("mes_2")}}" min="1" class="form-control" placeholder="Mes en el que se cobrara esta aportación" aria-label=" plan" aria-describedby="basic-addon2" required="">
							<div class="input-group-append">
								<span class="input-group-text " id="basic-addon2">Mes</span>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-12 col-sm-12 col-md-6 col-lg-4 offset-lg-2 col-xl-4 offset-xl-2 form-group">
						...
						<div class="input-group mb-3">
							<input type="number" step="any" name="aportacion_3" value="{{old("aportacion_3")}}" min="0" class="form-control" placeholder="Porcentaje de aportación" aria-label=" plan" aria-describedby="basic-addon2" required="">
							<div class="input-group-append">
								<span class="input-group-text " id="basic-addon2">%</span>
							</div>
						</div>
					...
					<div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 form-group">
						...
						<div class="input-group mb-3">
							...
							<input type="number" step="1" name="mes_3" value="{{old("mes_3")}}" min="1" class="form-control" placeholder="Mes en el que se cobrara esta aportación" aria-label=" plan" aria-describedby="basic-addon2" required="">
							<div class="input-group-append">
								<span class="input-group-text " id="basic-addon2">Mes</span>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-12 col-sm-12 col-md-6 col-lg-4 offset-lg-2 col-xl-4 offset-xl-2 form-group">
						...
						<div class="input-group mb-3">
							<input type="number" step="any" name="aportacion_liquidacion" value="{{old("aportacion_liquidacion")}}" min="0" class="form-control" placeholder="Porcentaje de aportación" aria-label=" plan" aria-describedby="basic-addon2" required="">
							<div class="input-group-append">
								<span class="input-group-text " id="basic-addon2">%</span>
							</div>
						</div>
					...
					<div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 form-group">
						...
						<div class="input-group mb-3">
							...
							<input type="number" step="1" name="mes_liquidacion" value="{{old("mes_liquidacion")}}" min="1" class="form-control" placeholder="Mes en el que se cobrara esta aportación" aria-label=" plan" aria-describedby="basic-addon2" required="">
							<div class="input-group-append">
								<span class="input-group-text " id="basic-addon2">Mes</span>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-12 col-sm-12 col-md-6 col-lg-2 col-xl-2 form-group">
						...
						<div class="input-group mb-3 mt-4">
							<input type="number" step="any" name="semestral" value="{{old("semestral")}}" min="0" class="form-control" placeholder="Semestral" aria-label=" plan" aria-describedby="basic-addon2" required="">
							<div class="input-group-append">
								<span class="input-group-text " id="basic-addon2">%</span>
							</div>
						</div>
					...
					<div class="col-12 col-sm-12 col-md-6 col-lg-2 col-xl-2 form-group">
						...
						<div class="input-group mb-3 mt-4">
							<input type="number" step="any" name="anual" value="{{old("anual")}}" min="0" class="form-control" placeholder="Anual" aria-label=" plan" aria-describedby="basic-addon2" required="">
							<div class="input-group-append">
								<span class="input-group-text " id="basic-addon2">%</span>
							</div>
						</div>
					...
					<div class="col-12 col-sm-12 col-md-6 col-lg-2 col-xl-2 form-group">
						...
						<div class="input-group mb-3 mt-4">
							<input type="number" step="any" name="inscripcion" value="{{old("inscripcion")}}" min="0" class="form-control" placeholder="Unico" aria-label=" plan" aria-describedby="basic-addon2" required="">
							<div class="input-group-append">
								<span class="input-group-text " id="basic-addon2">%</span>
							</div>
						</div>
					...
					<div class="col-12 col-sm-12 col-md-6 col-lg-2 col-xl-2 form-group">
						...
						<div class="input-group mb-3">
							<input type="number" step="any" name="cuota_admon" value="{{old("cuota_admon")}}" min="0" class="form-control" placeholder="Mensual" aria-label=" plan" aria-describedby="basic-addon2" required="">
							<div class="input-group-append">
								<span class="input-group-text " id="basic-addon2">%</span>
							</div>
						</div>
					...
					<div class="col-12 col-sm-12 col-md-6 col-lg-2 col-xl-2 form-group">
						...
						<div class="input-group mb-3 mt-4">
							<input type="number" step="any" name="s_v" value="{{old("s_v")}}" min="0" class="form-control" placeholder="Mensual" aria-label=" plan" aria-describedby="basic-addon2" required="">
							<div class="input-group-append">
								<span class="input-group-text " id="basic-addon2">%</span>
							</div>
						</div>
