                    ...
                    <div class="card-body">
                        <form
                            ...
                            {{-- <div class="card-body"> --}}
                                ...
                                <div class="row my-3">
                                    <div class="col-sm-3">
                                        <input type="radio" class="inputTipoPlan" name="plan-radio" id="plan-libre"
                                            value="libre">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="radio" class="inputTipoPlan" name="plan-radio" id="plan-clasica"
                                            value="clasica">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="radio" class="inputTipoPlan" name="plan-radio"
                                            id="plan-tradicional" value="tradicional">
                                        <label class="form-check-label" for="plan-tradicional">
                                            Tanda Tradicional
                                        </label>
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="radio" class="inputTipoPlan" name="plan-radio" id="plan-normal"
                                            value="normal">
                                ...
                                <div class="row">
                                    <div class="col-12 col-xs-12 col-md-4 col-lg-4 col-xl-3 form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <select name="monto" id="monto" class="form-control" required="">
                                                ...
                                                @for ($i = 300000; $i <= 20000000; $i+=50000) {{-- @if ($i%50000) --}}
                                    ...
                                    <div class="col-12 col-xs-12 col-md-4 col-lg-4 col-xl-3 form-group escondible">
                                        ...
                                        <select name="ahorro" id="ahorro_cliente" class="form-control input-escondible"
                                            required="">
                                    ...
                                    <div class="col-12 col-xs-12 col-md-4 col-lg-4 col-xl-3 form-group"
                                        id="contenedorInputPlanCliente" style="display:none;">
                                        <label for="plan">✱Plan</label>
                                        <select name="plan" id="plan_cliente" class="form-control input-escondible"
                                            required="">
                                            <option value="">Seleccionar</option>
                                    ...
                                    <div class="col-12 col-xs-12 col-md-3 col-lg-3 col-xl-3 form-group escondible">
                                        ...
                                        <div class="input-group mb-3">
                                            <input class="form-control input-escondible" type="number"
                                                id="descuento_input" name="descuento" min="0" max="30" value="0.00">
