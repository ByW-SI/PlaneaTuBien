	...
	<div class="collapse navbar-collapse" id="navbarNav">
		<ul class="navbar-nav">
            ...
            @if($hasPerfil || $hasUsuario)
		        <li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" data-target="#seguridad">
	        ...
	        @foreach(Auth::user()->perfil->componentes as $componente)
		        @if($componente->nombre == "indice prospectos")
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" data-target="#prospectos">
			...
			@foreach(Auth::user()->perfil->componentes as $componente)
				...
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" data-target="#recursos-humanos">
