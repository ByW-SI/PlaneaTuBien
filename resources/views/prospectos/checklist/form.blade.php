...
<div class="card">
	...
	@csrf
	    ...
	    <div class="card-body">
	    	...
	    	<div class="row">
	    		@if (!isset($contrato->checklist->ficha_deposito_path))
	    		...
	    		@endif
	    		@if (!isset($contrato->checklist->perfil_path))
	    		<div class="col-12 col-sm-12 col-md-4 col-xl-4 form-group">
	    		...
	    		@endif
	    		@if (!isset($contrato->checklist->presolicitud_path))
	    		<div class="col-12 col-sm-12 col-md-4 col-xl-4 form-group">
	    		...
	    		@endif
	    		@if (!isset($contrato->checklist->contrato_path))
	    		<div class="col-12 col-sm-12 col-md-4 col-xl-4 form-group">
	    		...
	    		@endif
	    		@if (!isset($contrato->checklist->hoja_aceptacion_path))
	    		<div class="col-12 col-sm-12 col-md-4 col-xl-4 form-group">
	    		...
	    		@endif
	    		@if (!isset($contrato->checklist->manual_consumidor_path))
	    		<div class="col-12 col-sm-12 col-md-4 col-xl-4 form-group">
	    		...
	    		@endif
	    		@if (!isset($contrato->checklist->calidad_path))
	    		<div class="col-12 col-sm-12 col-md-4 col-xl-4 form-group">
	    		...
	    		@endif
	    		@if (!isset($contrato->checklist->privacidad_path))
	    		<div class="col-12 col-sm-12 col-md-4 col-xl-4 form-group">
	    		...
	    		@endif
	    		@if (!isset($contrato->checklist->copia_ficha_deposito_path))
	    		<div class="col-12 col-sm-12 col-md-4 col-xl-4 form-group">
	    		...
	    		@endif
	    		@if (!isset($contrato->checklist->identificacion_path))
	    		<div class="col-12 col-sm-12 col-md-4 col-xl-4 form-group">
	    		...
	    		@endif
	    		@if (!isset($contrato->checklist->comprobante_domicilio_path))
	    		<div class="col-12 col-sm-12 col-md-4 col-xl-4 form-group">
	    		...
	    		@endif
	    		@if (!isset($contrato->checklist->croquis_ubicacion_path))
	    		<div class="col-12 col-sm-12 col-md-4 col-xl-4 form-group">
	    		...
	    		@endif
	    		@if (!isset($contrato->checklist->carta_bienvenida_path))
	    		<div class="col-12 col-sm-12 col-md-4 col-xl-4 form-group">
	    		...
	    		@endif
	    		@if (!isset($contrato->checklist->anexos_path))
	    		<div class="col-12 col-sm-12 col-md-4 col-xl-4 form-group">
