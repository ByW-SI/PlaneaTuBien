	...
	<div class="container">
		...
		<div class="row">
			<div class="twelve columns">
				...
				<p><strong>DECLARA EL CONSUMIDOR:</strong></p>
				<p>
				...
				<p>Para efectos de este Contrato de Adhesión se entenderá por: </p>
				<p>
		...
		<div class="row">
			<div class="twelve columns">
				...
				<p><strong>26.- Secretaría</strong>, A la Secretaría de Economía; </p>
				<p><strong>27.- Sistema de Comercialización</strong>, Al esquema consistente en la integración de grupos de Consumidores que aportan periódicamente sumas de dinero para ser administradas por el Proveedor, para efectos de adquisición de bienes determinados o determinables, como inmuebles destinados a la habitación, o a uso como locales comerciales; </p>
				<p><strong>28.- Valor histórico de las aportaciones del Consumidor</strong>, A la sumatoria de las aportaciones periódicas y extraordinarias al Fondo del Grupo y, en su caso, de las aportaciones periódicas al Fondo de Contingencia, pagadas por el Consumidor en términos nominales; </p>
				<p><strong>29.- Valor presente de las aportaciones del Consumidor</strong>, A la sumatoria de las multiplicaciones de los números de aportaciones periódicas y extraordinarias del Fondo del Grupo, y aportaciones periódicas al Fondo de Contingencia pagadas por el Consumidor, por el valor de las respectivas aportaciones que en términos del Contrato de Adhesión se encuentre vigente, y </p>
				<p><strong>30.- Valor presente de las aportaciones del Proveedor</strong>, Al resultado de multiplicar el número de bienes pagados por el Proveedor con recursos de su patrimonio para asegurar la adjudicación mínima e incrementar el número de Adjudicaciones de bienes, por el valor actual del bien, a la fecha de restitución de los recursos.</p>
				<p><strong>31.- Bienes Inmuebles</strong>, A los terrenos y construcciones terminadas, con uso del suelo destinada a casa habitación o como local comercial, nuevos o usados, con una vida útil remanente mayor al periodo de vigencia del Contrato de Adhesión y que cuenten con los permisos necesarios para tales fines; </p>
				<p><strong>32.- Precio de Adjudicación Indexado (PAI)</strong>, al precio inicial del bien inmueble contratado que se actualiza semestralmente, de acuerdo con las variaciones que tenga el Índice Nacional de Precios al Consumidor determinado por el Banco de México o por el índice que lo sustituya; </p>
				<p><strong>33.- Subasta</strong>, Al procedimiento para adjudicar un bien al Integrante que ofrezca en su grupo, el pago adelantado del mayor número de cuotas periódicas totales que sumadas a las ya pagadas sea mayor que los demás Consumidores, menos el importe correspondiente al Seguro de Vida, Incapacidad Permanente Total e Invalidez;</p>
				<p><strong>34.- Adjudicación por Antigüedad o Permanencia</strong>, Al procedimiento para determinar Adjudicatario en función de la antigüedad del Contrato de Adhesión del Consumidor, respecto de la antigüedad de los contratos de adhesión de los demás Consumidores del Grupo de que se trate;</p>
				<p><strong>35.- Adjudicación por Liquidación (directa)</strong>, Al procedimiento cuando se liquide al Proveedor el total de la operación contratada, que se presenta cuando se hace efectivo el derecho del Integrante del grupo o de sus beneficiarios de recibir el bien contratado, cuando el Consumidor, durante la vigencia del Contrato de Adhesión sufre de incapacidad e invalidez permanentes totales o fallece. Así como cuando se liquide al Proveedor, por cualquier otro medio, el valor total de la operación contratada;</p>
				<p><strong>36.- Plazo Contratado</strong>.- Al número de meses contratados por el Consumidor, que no puede ser mayor que los señalados en la carátula de este Contrato de Adhesión en “vigencia del plan” y </p>
				<p><strong>37.- Valor Histórico Promedio de la Aportaciones del Consumidor</strong>.- A la cantidad que resulta de dividir el monto del valor histórico entre el número de aportaciones pagadas.</p>
				<p><strong>CLÁUSULAS</strong></p>
				<p><strong>CAPITULO III</strong></p>
				<p><strong>FORMACIÓN DE GRUPOS</strong></p>
				<p>
		...
		<div class="row">
			<div class="twelve columns">
				...
				<p><strong>IX.03.- Derecho de adjudicación</strong>.- Por concepto de derecho de adjudicación, Planea Tu Bien S.A. de C.V. cobrará al adjudicatario el  2.5 % del PAI Adjudicado más el respectivo I.V.A., cantidad que se retendrá al adjudicatario.</p>
				<p>
		...
		<div class="row">
			<div class="twelve columns">
				...
				<p><strong>LIQUIDACIÓN DEL GRUPO</strong></p>
				<p>
