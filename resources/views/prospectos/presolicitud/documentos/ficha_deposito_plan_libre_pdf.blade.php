	...
	<div class="container">
		...
		<div class="row">
			<div class="twelve columns">
				...
				<div class="one-half column u-pull-right">
					<div class="one-half column u-pull-left">
						<p class="left">Aportación extraordinaria:</p>
					</div>
					<div class="one-half column u-pull-right">
						<p class="center" style="background: #cccc; border-radius:10px;">.</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="twelve columns">
				<div class="one-half column u-pull-left">
					...
					<div class="one-half column u-pull-right">
						<p class="center" style="background: #cccc; border-radius:10px;">{{$contrato->numero_contrato}}
						</p>
					</div>
				</div>
				<div class="one-half column u-pull-right">
		...
		<div class="row">
			<div class="twelve columns">
				<div class="one-half column u-pull-left">
					...
					<div class="one-half column u-pull-right">
						<p class="center" style="background: #cccc; border-radius:10px;">
							{{$contrato->presolicitud->id.$contrato->numero_contrato}}</p>
					</div>
				</div>
				<div class="one-half column u-pull-right">
					<div class="one-half column u-pull-left">
		...
		<div class="row">
			<div class="twelve columns">
				<div class="one-half column u-pull-left">
					...
					<div class="one-half column u-pull-right">
						<p class="center" style="background: #cccc; border-radius:10px;">
							{{$contrato->grupo->id.$contrato->numero_contrato.$presolicitud->cotizacion()->folio}}</p>
					</div>
				</div>
				<div class="one-half column u-pull-right">
					<div class="one-half column u-pull-left">
					...
					<div class="one-half column u-pull-right">
						<p class="center" style="background: #cccc; border-radius:10px;">1 a
							{{ $corrida_integrante['meses']}}</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="twelve columns">
				<div class="one-half column u-pull-left">
					...
					<div class="one-half column u-pull-right">
						<p class="center" style="background: #cccc; border-radius:10px;">
							${{number_format($corrida_integrante['aportacion'],2)}}</p>
				...
				<div class="one-half column u-pull-right">
					...
					<div class="one-half column u-pull-right">
						<p class="center" style="background: #cccc; border-radius:10px;">
							${{number_format($corrida_integrante['cuota_administracion'],2)}}</p>
		...
		<div class="row">
			<div class="twelve columns">
				<div class="one-half column u-pull-left">
					...
					<div class="one-half column u-pull-right">
						<p class="center" style="background: #cccc; border-radius:10px;">
							${{number_format($corrida_integrante['iva'],2)}}</p>
					</div>
				</div>
				<div class="one-half column u-pull-right">
					<div class="one-half column u-pull-left">
		...
		<div class="row">
			<div class="twelve columns">
				<div class="one-half column u-pull-left">
					...
					<div class="one-half column u-pull-right">
						<p class="center" style="background: #cccc; border-radius:10px;">
							${{number_format($corrida_integrante['sv'],2)}}</p>
					</div>
				</div>
				<div class="one-half column u-pull-right">
					<div class="one-half column u-pull-left">
					...
					<div class="one-half column u-pull-right">
						<p class="center" style="background: #cccc; border-radius:10px;">
							${{number_format($corrida_integrante['sd'],2)}}</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="twelve columns">
				<div class="one-half column u-pull-left">
					...
					<div class="one-half column u-pull-right">
						<p class="center" style="background: #cccc; border-radius:10px;">
							${{number_format($corrida_integrante['total'],2)}}</p>
					</div>
				</div>
			</div>
		</div> --}}
