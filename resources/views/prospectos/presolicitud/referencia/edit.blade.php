...
<div class="card">
	...
	<form method="POST"
		action="{{ route('prospectos.presolicitud.referencias.update',['prospecto'=>$prospecto,'presolicitud'=>$presolicitud,'referencia'=>1]) }}">
		@csrf
		@method('PUT')
		<div class="card-body">
			@if ($errors->any())
			...
			@foreach ($presolicitud->referencias as $i=>$referencia)
				...
				<div class="row">
					<input name="id" type="hidden" value="{{$referencia->id}}">
