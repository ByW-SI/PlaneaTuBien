	    ...
	    <div class="card">
		    ...
		    <div class="card-body">
				...
				<div class="form-group row">
					...
					<div class="col-sm-6">
						<input type="text" name="buro_credito" class="form-control">
					</div>
				</div>
				<hr>
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<div class="input-group">
							...
							<input type="number" step="any" min="0" class="form-control" name="limite_credito" id="limite_credito">
						</div>
					</div>
				</div>
				<hr>
				<div class="form-group row">
					...
					<div class="col-sm-2">
						...
						<div class="form-check form-check-inline mt-1">
							<input class="form-check-input" type="radio" name="tipo_destino_1" id="tipo_destino_1_mensual" value="Mensual">
				...
				<div class="form-group row">
					...
					<div class="col-sm-2">
						...
						<div class="form-check form-check-inline mt-1">
							<input class="form-check-input" type="radio" name="tipo_destino_2" id="tipo_destino_2_mensual" value="Mensual">
				...
				<div class="form-group row">
					...
					<div class="col-sm-2">
						...
						<div class="form-check form-check-inline mt-1">
							<input class="form-check-input" type="radio" name="tipo_destino_3" id="tipo_destino_3_mensual" value="Mensual">
				...
				<div class="form-group row">
					...
					<div class="col-sm-6">
						...
						<div class="form-check form-check-inline mt-1">
							<input class="form-check-input" type="radio" name="calificacion_credito" id="calificacion_credito_regular" value="Regular">
							<label class="form-check-label" for="calificacion_credito_regular">😐</label>
						</div>
						<div class="form-check form-check-inline mt-1">
							<input class="form-check-input" type="radio" name="calificacion_credito" id="calificacion_credito_mal" value="Mal">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<textarea class="form-control" rows="3" name="descripcion_calificacion" id="descripcion_calificacion"></textarea>
					</div>
				</div>
		    </div>
		    <div class="card-header">
		    ...
		    <div class="card-body">
		    	<div class="form-group row">
		    		<div class="col-sm-12">
		    			...
		    			<div class="form-check form-check-inline mt-1">
							<input class="form-check-input" type="radio" name="tipo_inmueble" id="tipo_inmueble_departamento" value="Departamento">
							<label class="form-check-label" for="tipo_inmueble_departamento">Departamento</label>
						</div>
		    			<div class="form-check form-check-inline mt-1">
							<input class="form-check-input" type="radio" name="tipo_inmueble" id="tipo_inmueble_terreno" value="Terreno">
							<label class="form-check-label" for="tipo_inmueble_terreno">Terreno</label>
						</div>
		    			<div class="form-check form-check-inline mt-1">
							<input class="form-check-input" type="radio" name="tipo_inmueble" id="tipo_inmueble_local" value="Local Comercial">
							<label class="form-check-label" for="tipo_inmueble_local">Local Comercial</label>
						</div>
		    			<div class="form-check form-check-inline mt-1">
							<input class="form-check-input" type="radio" name="tipo_inmueble" id="tipo_inmueble_bodega" value="Bodega">
				...
				<div class="form-group row">
		    		<div class="offset-3 col-sm-3">
		    			<div class="form-check form-check-inline mt-1">
							<input class="form-check-input" type="radio" name="tipo_inmueble" id="tipo_inmueble_otro" value="Otro">
							<label class="form-check-label" for="tipo_inmueble_otro">Otro:</label>
						</div>
					</div>
					<div class="col-sm-6">
						<input type="text" name="otro_name" class="form-control">
					</div>
		    	</div>
		    	<div class="form-group row">
		    	...
		    	<div class="form-group row">
		    		...
		    		<div class="col-sm-12">
		    			<textarea name="toma_desicion" class="form-control"></textarea>
		    		</div>
		    	</div>
		    	<div class="form-group row">
		    		<label class="col-form-label col-sm-12" for="lograr_meta">¿Porqué no ha logrado su meta?</label>
		    		<div class="col-sm-12">
		    			<textarea name="lograr_meta" class="form-control"></textarea>
		    		</div>
		    	</div>
		    	<div class="form-group row">
		    		...
		    		<div class="col-sm-12">
		    			<textarea name="motivo_tomaria_desicion" class="form-control"></textarea>
		    		</div>
		    	</div>
		    	<div class="form-group row">
