					...
					<div class="panel-heading">
						...
						<div class="row">
							<div class="col-sm-4">
								...
								<p>Préstamo para {{ $prospecto->nombre }} {{ $prospecto->appaterno }}.</p>
							</div>
						</div>
					</div>
					<div class="panel-body">
						<div class="row">
							<div class="form-group col-sm-12">
								...
								<p>Se adjunta la información del préstamo que solicitó para la cantidad de ${{ number_format($prestamo->prestamo, 2) }} a {{ $prestamo->meses }} meses.</p>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-12">
