...
class ChecklistFolderController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(Presolicitud $presolicitud,ChecklistFolder $checklist)
    {
        //
        $pdf = PDF::loadView('prospectos.presolicitud.documentos.checklist',['presolicitud'=>$presolicitud,'checklist'=>$checklist]);
        // return $pdf->stream();
        return $pdf->download('checklist'.$presolicitud->nombre.$presolicitud->paterno.$presolicitud->materno."checklist.pdf");
    }
