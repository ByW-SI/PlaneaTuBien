...
class PresolicitudBeneficiarioController extends Controller
{
    ...
    {
        //
         return redirect()->route('prospectos.presolicitud.referencias.edit',['prospecto'=>$prospecto,'presolicitud'=>$presolicitud,'beneficiario'=>1]);
    }
    ...
    {
        //
        return redirect()->route('prospectos.presolicitud.referencias.edit',['prospecto'=>$prospecto,'presolicitud'=>$presolicitud]);
