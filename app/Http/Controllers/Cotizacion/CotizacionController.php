...
class CotizacionController extends Controller
{
    ...
    public function Cotizacion(Request $request)
    {
        ...
        for ($i=0; $i < $plazo; $i++) { 
            ...
            array_push ($corridaTabla,[ $i+1,$Dia_de_inicio->format('m'),round($Aportacion,2),round($Cuota_Admin_monto,2),round($Seguro_vida_monto,2),round($Seguro_dano_monto,2),round(($Cuota_Admin_monto*0.16),2),round($Total,2),round($PagoAcumulado,2)]);
            $Dia_de_inicio->addMonths(1);
